...
| 连接/同步 | 跨端协议、服务端一次性 QR v2 bootstrap→独立凭据、Android 系统扫码/设备 key/TLS 1.3 pin/HMAC event-only client | 物理扫码与真机 P2P、无 Play services 替代、账户设备 registry、共享 Grant 撤销传播与后台同步尚未完成 |
